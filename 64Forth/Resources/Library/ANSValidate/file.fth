...
\ --- REPOSITION to start ---
0 0 FA-FID @ REPOSITION-FILE 0= S" REPOSITION" XEXPECT

\ --- READ-LINE ( c-addr u1 fileid -- u2 flag ior ) ---
PAD 80 FA-FID @ READ-LINE
0= S" READ-LINE-ior" XEXPECT
\ stack: u2 flag
DROP 5 = S" READ-LINE-u" XEXPECT
...
0= S" OPEN-FILE" XEXPECT
FA-FID !
PAD 80 FA-FID @ READ-LINE
0= S" OPEN-READ-ior" XEXPECT
DROP 5 = S" OPEN-READ-u" EXPECT
FA-FID @ CLOSE-FILE DROP

\ --- FILE-SIZE ---
S" /tmp/64forth-ansval-fa.txt" R/O OPEN-FILE
0= S" SIZE-OPEN" XEXPECT
FA-FID !
FA-FID @ FILE-SIZE
0= S" FILE-SIZE-ior" XEXPECT
OR 0= 0= S" FILE-SIZE-nz" XEXPECT
FA-FID @ CLOSE-FILE DROP
