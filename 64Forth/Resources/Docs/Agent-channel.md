...
**Status:** shipped (**64Forth 1.1.2+**; current **1.3.9**, build 38). Rebuild the app in Xcode before the installed binary supports `--agent`. See also [STATUS.md](STATUS.md) (section **v1.1.2 — agent channel**).
