...
**Last updated:** 2026-09-06 (64Forth **1.3.5**; interactive `CODE`/`END-CODE` from **1.3.1**)  
**Phase target:** 3.2 Assembler toolkit  
**Pack release:** 64TCOM ARM64 **Version 0.9** (with 64Forth **1.3.5**; last dual ship was **1.1.9** / pack with **1.2.0**)  
