...
**Public domain.**  
**Updated:** 2026-08-31 — **v1.2.1** (DEBUG help/resize/inline ±CELLS, pause spacing, ok> focus after DEBUG/⌘W; v1.2.0 LIT/control highlight + F8/Esc; v1.1.9 stack isolation / x28 NEXT; v1.1.8 TCOM TDBG; v1.1.7 ASMARM64; v1.1.6 DEBUG stepper).
